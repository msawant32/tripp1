               ...
               <div class="container">
				    <div class="row">
				        <div class="content">
				            <div class="panel-group" id="accordion">
				                ...
				                <div class="panel panel-default">
		                        <button style="width: 1170px;text-align: -webkit-auto;"  onclick="showDishDetails();">
				                    <div class="panel-heading">
				                         <h4 class="panel-title">
					                        <!-- <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"> -->
					                          <strong>Dosa's</strong>
				                      	</h4>
				                    </div>
		                        </button>
							 ...
							 <table class="table table-striped" border="3">
				                ...
				                <div class="panel panel-default">
							       <button style="width: 1170px;text-align: -webkit-auto;" 
							       				data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
					                    <div class="panel-heading">
						                         <h4 class="panel-title">
								                  <strong> "Mysore Dosa"</strong>  is served at following restaurants:
									              </h4>
					                    </div>
							        </button>
				  ...
				  <table class="table  table-striped">
					<tr>
						...
						<td width="12%">
							   <strong>Price<br>$10</strong><br><br>
